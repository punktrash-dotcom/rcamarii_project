...
class SugarcaneProfit {
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'SourceType': AppTextNormalizer.titleCase(sourceType),
      'SourceLabel': AppTextNormalizer.titleCase(sourceLabel),
      'SourceStatus': AppTextNormalizer.titleCase(sourceStatus),
